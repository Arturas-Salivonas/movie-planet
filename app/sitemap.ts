...
// Force Node.js runtime for file system access at BUILD TIME
export const runtime = 'nodejs'
export const dynamic = 'error' // Fail if trying to use dynamic, force static generation
export const revalidate = false // Never revalidate, generate once at build time
